export const postsData = [
    {
      ...
      content: `A Programação Orientada a Objetos (POO) é um paradigma que organiza o código 
    ...
    },
    {
      ...
      content: `Docker é uma plataforma que permite criar, implantar e rodar aplicativos em containers.
      ...
      tags: ["docker", "containers", "eficiência"],
      type: "devops",
